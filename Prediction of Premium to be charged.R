...
#----Read the dataset------
getwd()
setwd("C:/Users/Vishal/Documents/R")
Plan_Dataset <- read.csv("C:/Users/Vishal/Documents/R/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
setwd("C:/Users/Vishal/Documents/R")
sm2 <- read.csv("C:/Users/Vishal/Documents/R/InsurancePlanSubscriptions-2018.csv")
View(sm2)
